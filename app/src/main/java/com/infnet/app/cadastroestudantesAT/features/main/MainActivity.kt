...
import com.infnet.app.cadastroestudantesAT.adapter.ItemAdapter
import com.infnet.app.cadastroestudantesAT.databinding.ActivityMainBinding
...
class MainActivity : BaseActivity<ActivityMainBinding, MainActivityViewModel>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab_add.setOnClickListener {
            ...
            dialogBuilder.setTitle("Inserir Dados")
            ...
            dialogBuilder.setPositiveButton("Adicionar") { _: DialogInterface, _: Int ->
                ...
                applicationContext.toast("Dados adicionados com sucesso")
